...
import type { ParsedSchema, Model } from "../parser/types";
import type { TraversalOptions, TraversalResult, TraversedModel } from "./types";
...
export function traverseModels(
  ...
  while (queue.length > 0) {
    // Dequeue the next model to process
